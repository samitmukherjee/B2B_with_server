...
<!-- Mirrored from themerail.com/html/listingGeo/admin/profile.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 May 2020 13:45:32 GMT -->
<head>
    <meta charset="UTF-8">
				...
				<div class="row">
					<div class="page-title-block">
						...
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="#">Extrapage</a></li>
						...
						<div class="profile-block">
							<div class="profile-cover-block">
								<div class="cover-image">
									<a href="#">
										<img src="images/profile/cover.jpg" class="img-responsive" alt="img">	
									</a>
									<div class="profile-img-container">
										<a href="#">
											<img src="images/profile/profile.jpg" class="img-responsive" alt="img">
										</a>
									</div>
								</div>
							</div><!-- profile-cover-block -->
							<div class="profile-detail-block">
								<div class="profieInfo-block">
									<div class="profileInfo">
										<h5><a href="#">Robert Smith</a></h5>
										<span>@uidesigner</span>
									</div>
									<div class="profileSettings">
										<a href="javascript:void(0)" class="btn btn-h-sm btn-success btn-fab waves-effect waves-light">
											<i class="fa fa-cog" aria-hidden="true"></i>
											<div class="ripple-container"></div>
										</a>
									</div>
								</div>
								<div class="profileStatistic-block">
									<table class="table table-bordered">
										<tbody>
											<tr>
												<td>
													<h3 class="profileCounter">45826</h3>
													<span>Posts</span>
												</td>
												<td class="text-counter">
													<h3 class="profileCounter">14</h3><h3>K</h3>
													<span>Followers</span>
												</td>
												<td>
													<h3 class="profileCounter">1596</h3>
													<span>Following</span>
												</td>
											</tr>
										</tbody>
									</table>
								</div><!-- profileStatistic-block -->
								<div class="about-profile-block">
									<h5>About Me</h5>
									<p>
										Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam architecto beatae cupiditate 
										delectus dicta dolores doloribus eaque eos esse excepturi expedita illum inventore ipsam 
										iste iusto  Praesent libero. Sed cursus ante dapibus diam. Sed nisi.
									</p>
								</div><!-- about-profile-block -->
								<div class="profile-contact-block">
									<h5>Contact Information</h5>
									<p><strong>Full Name :</strong>Robart Smith Doe</p>
									<p><strong>Mobile : </strong>(123) 123 1234</p>
									<p><strong>Email : </strong>coderthemes@gmail.com</p>
								...
								</div><!-- profile-social-block -->
							</div><!-- profile-detail-block -->
						</div><!-- profile-block -->
					</div>
					<div class="col-lg-8">
						<div class="post-area-block">
							<div class="composer-text-box">
								<form method="post">
									<textarea rows="100" cols="50" placeholder="Write Something"></textarea>
									<div class="post-update-options">
										<ul class="compose-options">
										...
										<div class="btn-area">
											<button type="button" class="btn btn-xs btn-primary btn-raised waves-effect">Post</button>
										</div>
										<div class="clearfix"></div>
									</div>
								</form>
							...
							<div class="post-block">
								<article>
									<div class="post-author-block">
										<a href="#">
											<img src="images/misc/author-1.jpg" class="img-responsive" alt="img">
										</a>
										<div>
											<h5>Rosa E. Spencer</h5>
									...
									<div class="post-thumb">
										<div>
											<img src="images/misc/post-1.jpg" class="img-responsive double" alt="img">
											<img src="images/misc/post-2.jpg" class="img-responsive double" alt="img">
										</div>
									</div>
									<div class="post-meta">
										<span><i class="fa fa-heart-o" aria-hidden="true"></i><a href="#">456 Likes</a></span>
										<span><i class="fa fa-comments-o" aria-hidden="true"></i><a href="#">46 Comments</a></span>
									</div>
								</article>
								<article>
									<div class="post-author-block">
										<a href="#">
											<img src="images/misc/author-2.jpg" class="img-responsive" alt="img">
										</a>
										<div>
											<h5>Raymon M. Bracamonte</h5>
											<span>1 hour ago</span>
										</div>
									</div>
									<div class="post-thumb">
										<img src="images/misc/post-3.jpg" class="img-responsive" alt="img">
									</div>
									<div class="post-meta">
										<span><i class="fa fa-heart-o" aria-hidden="true"></i><a href="#">456 Likes</a></span>
										<span><i class="fa fa-comments-o" aria-hidden="true"></i><a href="#">46 Comments</a></span>
								...
								<article>
									...
									<div class="post-entry">
										<p>
											When an unknown printer took a galley of type and scrambled it to make a type specimen book.
											It has survived not only five centuries, but also the leap into electronic typesetting, 
											remaining essentially unchanged. of Letraset sheets containing Lorem Ipsum passages, 
...
<!-- Mirrored from themerail.com/html/listingGeo/admin/profile.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 May 2020 13:45:35 GMT -->
</html>
