...
<!-- Mirrored from themerail.com/html/listingGeo/admin/accordian.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 May 2020 13:45:28 GMT -->
<head>
    <meta charset="UTF-8">
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div class="accordian-block">
										<div id="accordion1" class="accordian-common" role="tablist" aria-multiselectable="true">
											<div class="card">
					...
					<div class="col-lg-6">
						<div class="box-widget">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div class="accordian-block">
										<div id="accordion2" class="accordian-common" role="tablist" aria-multiselectable="true">
											<div class="card">
					...
					<div class="col-lg-6">
						<div class="box-widget">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div class="accordian-block">
										<div id="accordion3" class="accordian-common scale-accordian" role="tablist" aria-multiselectable="true">
											<div class="card">
					...
					<div class="col-lg-6">
						<div class="box-widget">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div class="accordian-block">
										<div id="accordion4" class="accordian-common color-accordian" role="tablist" aria-multiselectable="true">
											<div class="card has-primary">
											...
											<div class="card has-info">
												<div class="card-header" role="tab" id="headingEleben">
													<h5 class="mb-0">
														<a class="collapsed" data-toggle="collapse" data-parent="#accordion4" href="#collapseEleben" aria-expanded="false" aria-controls="collapseEleben">
															Collapsible Group Item 02
														</a>
													</h5>
												</div>
												<div id="collapseEleben" class="collapse" role="tabpanel" aria-labelledby="headingEleben">
													<div class="card-block">
														It is a long established fact that a reader will be distracted by the readable content
														of a page when looking at its layout. The point of using Lorem Ipsum is that it has
														a more-or-less normal distribution of letters, as opposed to using 'Content here,
