...
<!-- Mirrored from themerail.com/html/listingGeo/admin/vector-map.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 May 2020 13:45:29 GMT -->
<head>
    <meta charset="UTF-8">
...
<body class="menu-collapsed">
						...
						<div class="box-widget">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div id="vectorWorldMap" class="vector-map world-vector-map"></div>
								</div><!--panel Body -->
							</div><!--panel -->
						</div><!-- widget-module -->
					</div>
					<div class="col-lg-6">
						<div class="box-widget">
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<div id="vectorUsMap" class="vector-map us-vector-map"></div>
									</div><!--panel Body -->
								</div><!--panel -->
						</div><!-- widget-module -->
					</div>
					<div class="col-lg-6">
						<div class="box-widget">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div id="vectorAustraliaMap" class="vector-map australia-vector-map"></div>
								</div><!--panel Body -->
							</div><!--panel -->
						</div><!-- widget-module -->
					</div>
					<div class="col-lg-6">
						<div class="box-widget">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div id="vectorFranceMap" class="vector-map france-vector-map"></div>
								</div><!--panel Body -->
							</div><!--panel -->
						</div><!-- widget-module -->
					</div>
					<div class="col-lg-6">
						<div class="box-widget">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div id="vectorUkMap" class="vector-map uk-vector-map"></div>
								</div><!--panel Body -->
							</div><!--panel -->
						</div><!-- widget-module -->
					</div>
						...
						<div class="box-widget widget-module">
							<div class="widget-body">
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<div id="vectorIndiaMap" class="vector-map uk-vector-map"></div>
									</div><!--panel Body -->
								</div><!--panel -->
							</div>
						</div><!-- widget-module -->
					...
					<div class="col-lg-6">
						<div class="box-widget">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div id="vectorCanadaMap" class="vector-map canada-vector-map"></div>
								</div><!--panel Body -->
							</div><!--panel -->
						</div><!-- widget-module -->
					</div>
	...
	<script src="assets/js/ammap/usaLow.js"></script>
	<script src="assets/js/ammap/australiaLow.js"></script>
	<script src="assets/js/ammap/franceLow.js"></script>
	<script src="assets/js/ammap/unitedKingdomLow.js"></script>
	<script src="assets/js/ammap/indiaLow.js"></script>
	<script src="assets/js/ammap/canadaLow.js"></script>
	<script>
		...
		AmCharts.ready(function(){
			...
			map.areasSettings = {
				...
				color: "#83e9d2",
				colorSolid: "#83e9d2",
				unlistedAreasOutlineColor: "#83e9d2",
				unlistedAreasOutlineAlpha: 0.5
			};
			map.smallMap = false;
			map.write("vectorUsMap");
			//USA-vector-map Invoked Here
			...
			map.areasSettings = {
				...
				color: "#ff7979",
				colorSolid: "#ff7979",
				unlistedAreasOutlineColor: "#ff7979",
				unlistedAreasOutlineAlpha: 0.5
				
			};
			map.smallMap = false;
			map.write("vectorAustraliaMap");
			//Australia-vector-map Invoked Here
			...
			map.areasSettings = {
				...
				color: "#ffce2e",
				colorSolid: "#ffce2e",
				unlistedAreasOutlineColor: "#ffce2e",
				unlistedAreasOutlineAlpha: 0.5
			};
			map.smallMap = false;
			map.write("vectorFranceMap");
			//Francef-vector-map Invoked Here
			...
			map.areasSettings = {
				...
				color: "#444444",
				colorSolid: "#444444",
				unlistedAreasOutlineColor: "#444444",
				unlistedAreasOutlineAlpha: 0.5
			};
			map.smallMap = false;
			map.write("vectorUkMap");
			//UnitedKingdom-vector-map Invoked Here
			...
			map.areasSettings = {
				...
				color: "#11ed8e",
				colorSolid: "#11ed8e",
				unlistedAreasOutlineColor: "#11ed8e",
				unlistedAreasOutlineAlpha: 0.5
			};
			map.smallMap = false;
			map.write("vectorIndiaMap");
			//India-vector-map Invoked Here
			...
			map.areasSettings = {
				...
				color: "#875ea8",
				colorSolid: "#875ea8",
				unlistedAreasOutlineColor: "#875ea8",
				unlistedAreasOutlineAlpha: 0.5
			};
			map.smallMap = false;
			map.write("vectorCanadaMap");
			//Canada-vector-map Invoked Here
		});
	</script>
...
<!-- Mirrored from themerail.com/html/listingGeo/admin/vector-map.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 May 2020 13:45:31 GMT -->
</html>
