							...
							<div class="form-block">
								<form class="form-common">
									<div class="form-group row">
										<div class="col-md-12">
											<input type="email" class="form-control" id="inputUserNamel3" placeholder="User Name">
										</div>
									</div>
									<div class="form-group row">
										<div class="col-md-12">
									...
									<div class="form-group row last">
										<div class="col-md-12">
											<div class="form-btn-block">
												<button type="button" class="btn btn-raised btn-primary waves-effect waves-light btn-block">Login</button>
											</div>
										</div>
									</div>
								</form>
