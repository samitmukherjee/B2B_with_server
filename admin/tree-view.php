...
<!-- Mirrored from themerail.com/html/listingGeo/admin/tree-view.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 May 2020 13:45:32 GMT -->
<head>
    <meta charset="UTF-8">
						...
						<div class="box-widget">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div class="treeview-common treeview-dotted">
										<ul class="tree-view parent-ul">
					...
					<div class="col-md-6">
						<div class="box-widget">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div class="treeview-common treeview-dotted circled">
										<ul class="tree-view parent-ul">
											<li class="active"><a href="#">Admin</a>
												<ul>
													<li>Asset
					...
					<div class="col-md-6">
						<div class="box-widget">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div class="treeview-common circled">
										<ul class="tree-view parent-ul">
											<li class="active"><a href="#">Admin</a>
												<ul>
													<li>Asset
					...
					<div class="col-md-6">
						<div class="box-widget">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div class="treeview-common folder">
										<ul class="tree-view parent-ul">
											<li class="parent-list">
												Admin
											</li>
											<li class="active parent-list has-child"><a href="#">Dashboard</a>
												<ul>
													<li>Tables</li>
													<li class="active">Ui Elements
														<ul>
															<li class="active has-child">Elements
																<ul class="selected">
																	<li>Elements 1</li>
																	<li>Elements 2</li>
																	<li>Elements 3</li>
					...
					<div class="col-md-6">
						<div class="box-widget">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div class="treeview-common folder folder-fill">
										<ul class="tree-view parent-ul">
											<li class="parent-list">
												Admin
											</li>
