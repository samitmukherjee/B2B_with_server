					...
					<div class="row">
						<div class="col-lg-2">
							<div class="inbox-sidebar">
								<ul class="inbox-nav">
									<li>
										<a href="javascript:void(0)" class="active"><i class="text-right"></i> Pending <span class="badge warning">10</span></a>
									</li>
									<li>
										<a href="javascript:void(0)"><i class="text-right"></i>Verified</a>
									</li>
									<!-- <li>
								...
								<div class="inbox-content">
									<table class="table inbox-table table-advance table-bordered">
										<thead>
											<tr>
												<th colspan="6">
													<div class="form-common left-block">
														<!-- <label class="custom-control custom-checkbox">
															<input type="checkbox" class="custom-control-input">
															<span class="custom-control-indicator"></span>
															<span class="custom-control-description"></span>
														</label> -->
														<a href="#" class="btn btn-outline-default btn-raised waves-effect"><i class="fa fa-refresh" aria-hidden="true"></i> Refresh</a>
														<!-- <div class="btn-group">
															<a href="javascript:void(0)" class="btn btn-outline-default btn-raised waves-effect btn-icon">
																<i class="fa fa-eye" aria-hidden="true"></i><div class="ripple-container"></div>
															</a>
															<a href="javascript:void(0)" class="btn btn-outline-default btn-raised waves-effect btn-icon">
													...
													<!-- <div class="right-block">
														<span class="pagination-info"> 1 - 15 of 155 </span>
														<a href="javascript:void(0)" class="btn btn-outline-default btn-raised waves-effect btn-icon">
										...
										<tbody>
											<tr data-messageid="4">
												...
												<td class="sender-name hidden-xs">User Name</td>
												<td class="view-message">Business Name</td>
												<td class="view-message">Business Category</td>
												<!-- <td class="view-message inbox-small-cells">
													<i class="fa fa-paperclip" aria-hidden="true"></i>
												</td> -->
												<td class="view-message text-right">20:46</td>
											</tr>
											<!-- <tr data-messageid="4">
												<td class="inbox-small-cells">
													<div class="form-common">
												...
												<td class="sender-name hidden-xs">Katherine M. Milner</td>
												<td class="view-message">Contrary to popular belief, Lorem Ipsum is not</td>
											...
											<tr data-messageid="4">
												...
												<td class="inbox-small-cells">
													<a href="javascript:void(0)"><i class="fa fa-star inbox-stard"></i></a>
												</td>
												<td class="sender-name hidden-xs">Annie M. Gilbert</td>
												<td class="view-message">If you are going to use a passage of Lorem Ipsum</td>
												<td class="view-message inbox-small-cells">
													<i class="fa fa-paperclip" aria-hidden="true"></i>
												</td>
												<td class="view-message text-right">12:18</td>
											</tr>
											<tr data-messageid="4">
												<td class="inbox-small-cells">
													<div class="form-common">
												...
												<td class="sender-name hidden-xs">Paula C. Hogan</td>
												<td class="view-message">Letraset sheets containing Lorem Ipsum passages</td>
												<td class="view-message inbox-small-cells"></td>
												<td class="view-message text-right">07 Mar</td>
											</tr>
											<tr data-messageid="4">
												<td class="inbox-small-cells">
													<div class="form-common">
												...
												<td class="sender-name hidden-xs">Maricela C. Mortensen</td>
												<td class="view-message">If you are going to use a passage</td>
												<td class="view-message inbox-small-cells">
													<i class="fa fa-paperclip" aria-hidden="true"></i>
												</td>
												<td class="view-message text-right">12:18</td>
											...
											<tr data-messageid="4">
												...
												<td class="sender-name hidden-xs">Amber M. Solomon</td>
												<td class="view-message">It is a long established fact that a reader will be distracted </td>
												<td class="view-message inbox-small-cells">
													<i class="fa fa-paperclip" aria-hidden="true"></i>
												</td>
												<td class="view-message text-right">20:46</td>
