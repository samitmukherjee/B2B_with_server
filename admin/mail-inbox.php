												...
												if(mysqli_num_rows($result) > 0){
													...
													while($row = mysqli_fetch_array($result)){
														...
														<tr id="<?php $row['business_id'] ?>">
															...
															<td>
																<embed src="./.<?php echo $row['bank_details']?>" style="height:200px; width:200px;" >
															</td>
	...
	<script>
		$(document).ready(function(){
			...
			$(document).on('click','button[data-role=verify_business]',function(){
				...
				$.post('./php_form/verify_business_form.php',{"business_id":business_id},function(){
					console.log('business verified');
					location.reload();
				});
			});
			$('button[data-role=verify_business]').css({"background-color" : "#e5e500", "border" : "0", "color" : "#000", "width" : "60px", "border-radius" : "4px"});
		});
