	...
	<div class="apps-container-wrap page-container">
		<div class="page-content">
			<div class="container-fluid">
				...
				<div class="container">
				<form id="add_category_form" method="POST" class="form-common add-listing-form" action="./php_form/add_designation_form.php" enctype="multipart/form-data" novalidate="novalidate" style="border: 1px solid black; padding: 20px;">
					<div class="listing-block businessinfo-listing">
						<h4>Add Executive Designation</h4>
						<div class="row">
							<div class="col-lg-6">
								<div class="businessinfo-left-block">
									<div class="form-group">
										<label for="designation">Designation Name</label>
										<input id="designation" name="designation" type="text" class="form-control form-single-element" placeholder="Ex: Sales Executive, Inventory Manager" required>
									</div>
								</div>
							</div>
							<!-- col-lg-6 -->
							<div class="col-lg-6">
								<button type="submit" class="danger-btn" id="designation_btn" name="designation_btn" style="margin-top: 6%;width: 20%;height: 44%; background-color: #3867D6; color: #fff; border-radius: 4px; border:0;">
