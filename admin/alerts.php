...
<!-- Mirrored from themerail.com/html/listingGeo/admin/alerts.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 May 2020 13:45:28 GMT -->
<head>
    <meta charset="UTF-8">
						...
						<div class="box-widget">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div class="default-alert-block">
										<div class="alert alert-default alert-dismissible alert-success">
											<i class="fa fa-check-circle-o left-icon" aria-hidden="true"></i>
											<p><strong>Success!</strong>  You successfully read this important alert message.</p>
											<button type="button" class="close" data-dismiss="alert"><i class="fa fa-times"></i></button>
										</div>
										<div class="alert alert-default alert-dismissible alert-info">
											<i class="fa fa-info left-icon" aria-hidden="true"></i>
											<p><strong>Info!</strong>  You successfully read this important alert message.</p>
											<button type="button" class="close" data-dismiss="alert"><i class="fa fa-times"></i></button>
										</div>
										<div class="alert alert-default alert-dismissible alert-warning">
											<i class="fa fa-exclamation-triangle left-icon" aria-hidden="true"></i>
											<p><strong>Warning!</strong>  You successfully read this important alert message.</p> 
											<button type="button" class="close" data-dismiss="alert"><i class="fa fa-times"></i></button>
										</div>
										<div class="alert alert-default alert-dismissible alert-danger">
											<i class="fa fa-exclamation-circle left-icon" aria-hidden="true"></i>
											<p><strong>Danger!</strong>  You successfully read this important alert message.</p>
											<button type="button" class="close" data-dismiss="alert"><i class="fa fa-times"></i></button>
										</div>
					...
					<div class="col-lg-6">
						<div class="box-widget">
							<div class="panel panel-default">
								<div class="panel-heading">
									<div class="panel-title">
										<h4>Contrasts Alerts</h4>
									</div>
								</div>
								<div class="panel-body">
									<div class="contrasts-alert-block">
										<div class="alert contrasts-alert alert-dismissible alert-success">
											<i class="fa fa-check-circle-o left-icon" aria-hidden="true"></i>
											<p><strong>Success!</strong>  You successfully read this important alert message.</p>
											<button type="button" class="close" data-dismiss="alert"><i class="fa fa-times"></i></button>
										</div>
										<div class="alert contrasts-alert alert-dismissible alert-info">
											<i class="fa fa-info left-icon" aria-hidden="true"></i>
											<p><strong>Info!</strong>  You successfully read this important alert message.</p>
											<button type="button" class="close" data-dismiss="alert"><i class="fa fa-times"></i></button>
										</div>
										<div class="alert contrasts-alert alert-dismissible alert-warning">
											<i class="fa fa-exclamation-triangle left-icon" aria-hidden="true"></i>
											<p><strong>Warning!</strong>  You successfully read this important alert message.</p>
											<button type="button" class="close" data-dismiss="alert"><i class="fa fa-times"></i></button>
										</div>
										<div class="alert contrasts-alert alert-dismissible alert-danger">
											<i class="fa fa-exclamation-circle left-icon" aria-hidden="true"></i>
											<p><strong>Danger!</strong>  You successfully read this important alert message.</p>
											<button type="button" class="close" data-dismiss="alert"><i class="fa fa-times"></i></button>
										</div>
					...
					<div class="col-lg-6">
						<div class="box-widget">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div class="contrasts-alert-block">
										<div class="alert contrasts-alert alert-dismissible alert-success transparent">
											<i class="fa fa-check-circle-o left-icon color-bg" aria-hidden="true"></i>
											<p><strong>Success!</strong>  You successfully read this important alert message.</p>
											<button type="button" class="close" data-dismiss="alert"><i class="fa fa-times"></i></button>
										</div>
										<div class="alert contrasts-alert alert-dismissible alert-info transparent">
											<i class="fa fa-info left-icon color-bg" aria-hidden="true"></i>
											<p><strong>Info!</strong>  You successfully read this important alert message.</p>
											<button type="button" class="close" data-dismiss="alert"><i class="fa fa-times"></i></button>
										</div>
										<div class="alert contrasts-alert alert-dismissible alert-warning transparent">
											<i class="fa fa-exclamation-triangle left-icon color-bg" aria-hidden="true"></i>
											<p><strong>Warning!</strong>  You successfully read this important alert message.</p>
											<button type="button" class="close" data-dismiss="alert"><i class="fa fa-times"></i></button>
										</div>
										<div class="alert contrasts-alert alert-dismissible alert-danger transparent">
											<i class="fa fa-exclamation-circle left-icon color-bg" aria-hidden="true"></i>
											<p><strong>Danger!</strong>  You successfully read this important alert message.</p>
											<button type="button" class="close" data-dismiss="alert"><i class="fa fa-times"></i></button>
										</div>
									</div><!-- basic-progress-bar-block -->
						...
						<div class="box-widget">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div class="contrasts-alert-block">
										<div class="alert contrasts-alert alert-dismissible alert-success transparent">
											<i class="fa fa-check-circle-o left-icon color-icon" aria-hidden="true"></i>
											<p><strong>Success!</strong>  You successfully read this important alert message.</p>
											<button type="button" class="close" data-dismiss="alert"><i class="fa fa-times"></i></button>
										</div>
										<div class="alert contrasts-alert alert-dismissible alert-info transparent">
											<i class="fa fa-info left-icon color-icon" aria-hidden="true"></i>
											<p><strong>Info!</strong>  You successfully read this important alert message.</p>
											<button type="button" class="close" data-dismiss="alert"><i class="fa fa-times"></i></button>
										</div>
										<div class="alert contrasts-alert alert-dismissible alert-warning transparent">
											<i class="fa fa-exclamation-triangle left-icon color-icon" aria-hidden="true"></i>
											<p><strong>Warning!</strong>  You successfully read this important alert message.</p>
											<button type="button" class="close" data-dismiss="alert"><i class="fa fa-times"></i></button>
										</div>
										<div class="alert contrasts-alert alert-dismissible alert-danger transparent">
											<i class="fa fa-exclamation-circle left-icon color-icon" aria-hidden="true"></i>
											<p><strong>Danger!</strong>  You successfully read this important alert message.</p>
											<button type="button" class="close" data-dismiss="alert"><i class="fa fa-times"></i></button>
										</div>
									</div><!-- basic-progress-bar-block -->
