...
<!-- Mirrored from themerail.com/html/listingGeo/admin/form-wizard.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 May 2020 13:45:28 GMT -->
<head>
    <meta charset="UTF-8">
												...
												<section>
													...
													<div class="row">
														...
														<div class="form-group col-lg-6">
															<input id="userName" type="text" class="form-control required" placeholder="First Name">
														</div>
														<div class="form-group col-lg-6">
															<input  type="text" class="form-control renter-block required" placeholder="Last Name">
														</div>
													</div>
													<div class="form-group">
														<label for="email">Email</label>
														<input id="email"  type="email" class="form-control required email" placeholder="Enter Email">
													</div>
													<div class="row">
														<div class="form-group mrg-b-0 col-12">
														...
														<div class="form-group col-lg-6">
															<input id="password" type="password" class="form-control required" placeholder="Passwoed">
														</div>
														<div class="form-group col-lg-6">
															<input id="confirm" type="password" class="form-control renter-block required" placeholder="Re type password">
														</div>
													</div>
												</section>
												<div class="form-wizard-circle">
