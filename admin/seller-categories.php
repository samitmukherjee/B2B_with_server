                            ...
                            <div class="item col-lg-4 col-md-6" id="append_card">
                                ...
                                <article class="popular-listing-post">
                                    ...
                                    <div class="post-thumb">
                                        <img src="images/post/office.jpg" alt="img" class="img-responsive" style="width: 100%; height: 200px">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="footer-widget">
                                    ...
                                    <p class="address">
                                        <i class="fa fa-map-marker" aria-hidden="true"></i> Suite # 25/B, Green Street
                                        California, CA78542
                                    </p>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-6 pull-md-6">
                                <p class="copyright-text">Copyright 2018, <a href="javascript:void(0)">ListingGEO</a>.
