    ...
    if(isset($_POST['admin_submit_button'])){
        ...
        //     }
            ...
            if(isset($profile_picture_name) and !empty($profile_picture_name)){
                $location = '../../uploads/admin_details/homepage_banner/';
                $location_1 = './uploads/admin_details/homepage_banner/';
        ...
        if($_FILES['profile_picture']['size'] != 0){
            echo "TEST";
            $query_update_profile = " UPDATE homepage_image SET banner_image='".$profile_picture."' WHERE customize_id = '1' ";
        ...
        //     echo ' alert("Please select a file to Upload")';  //not showing an alert box.
        //     echo '</script>';
        // }
