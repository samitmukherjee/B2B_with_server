	...
	<div class="apps-container-wrap page-container">
		<div class="page-content">
			<div class="container-fluid">
				...
				<div class="container">
				<form id="add_subcategory_form" method="POST" class="form-common add-listing-form" action="./php_form/add_subcategory_form.php" enctype="multipart/form-data" novalidate="novalidate" style="padding: 20px;">
							...
							<div class="col-lg-3">
								<div class="form-group">
									...
									<table>
										<tr>
											<td width=275>
												<select id="category" name="category" style="width: 100%; height: 45px; border-radius: 3px; background-color: white !important;" required>
							...
							<div class="col-lg-9">
								<div class="businessinfo-left-block">
									<div class="form-group" style="width: 100%;">
										...
										<input id="subcategory" name="subcategory" type="text" class="form-control form-single-element" placeholder="Ex: Hospitality" required>
									</div>
								</div>
							</div>
							<!-- col-lg-6 -->
							<div class="col-lg-12">
								<button type="submit" class="danger-btn" id="category_btn" name="category_btn" style="margin-top: 6%; width: 20%;height: 44%; background-color: #3867D6; color: #fff; border-radius: 4px; border:0;">
