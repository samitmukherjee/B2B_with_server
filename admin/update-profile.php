						...
						<div class="row">
							<div class="col-lg-2">
								<div class="form-group" style="max-width: 100%; max-height: 100%; display: block;">
									<div>
										<img src="./.<?php echo $row['admin_profile_picture']?>" style="width: 125px; height:125px;">
									</div>
								</div>
							</div>
							<div class="col-lg-10">
							...
							<div class="col-lg-6">
								<div class="businessinfo-left-block">
									<div class="form-group">
										<input name="admin_id" value="<?php echo $_SESSION['user_id']?>" type="hidden">
										<label>First Name</label>
										<input id="first_name" name="first_name" type="text" class="form-control form-single-element" value="<?=$row['first_name'] ?>" placeholder="Ex: Manas" required>
									</div>
									<div class="form-group">
							...
							<div class="col-lg-6">
								...
								<div class="form-group">
										...
										<input id="last_name"  name="last_name" type="text" class="form-control form-single-element" value="<?=$row['last_name'] ?>" placeholder="Ex: Singh" required>
									</div>
									<div class="form-group">
										<label>Email ID</label>
										<input id="email_id" name="email_id" type="email" class="form-control" value="<?=$row['admin_email_id'] ?>" placeholder="Ex: info@example.com" required>
									</div>
								</div>
							</div>
						</div>
