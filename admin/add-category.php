	...
	<div class="apps-container-wrap page-container">
		<div class="page-content">
			<div class="container-fluid">
				...
				<div class="container">
				<form id="add_category_form" method="POST" class="form-common add-listing-form" action="./php_form/add_category_form.php" enctype="multipart/form-data" novalidate="novalidate" style="padding: 20px;">
							...
							<div class="col-lg-6">
								<div class="businessinfo-left-block">
									<div class="form-group">
										...
										<input id="category" name="category" type="text" class="form-control form-single-element" placeholder="Ex: Hospitality" required>
									</div>
								</div>
							</div>
							<!-- col-lg-6 -->
