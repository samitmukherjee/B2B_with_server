...
<!-- Mirrored from themerail.com/html/listingGeo/admin/input-mask.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 May 2020 13:45:28 GMT -->
<head>
    <meta charset="UTF-8">
						...
						<div class="box-widget">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div class="form-block input-mask-block">
										<form class="form-common ">
											<div class="form-group row">
												<label for="inputDate" class="col-lg-2 col-form-label">Date</label>
												<div class="col-lg-10">
													<input type="text" class="form-control" id="inputDate">
												</div>
											</div>
											<div class="form-group row">
												<label for="inputPhone1" class="col-lg-2 col-form-label">Phone</label>
												<div class="col-lg-10">
													<input type="text" class="form-control" id="inputPhone1">
												</div>
											</div>
											<div class="form-group row">
												<label for="inputPhone2" class="col-lg-2 col-form-label">Phone + Opcional Ext</label>
												<div class="col-lg-10">
													<input type="text" class="form-control" id="inputPhone2">
												</div>
											</div>
											<div class="form-group row">
												<label for="inputIntPhone" class="col-lg-2 col-form-label">Int Phone</label>
												<div class="col-lg-10">
													<input type="text" class="form-control" id="inputIntPhone">
												</div>
											</div>
											<div class="form-group row">
												<label for="inputTaxId" class="col-lg-2 col-form-label">Tax Id</label>
												<div class="col-lg-10">
													<input type="text" class="form-control" id="inputTaxId">
												</div>
											</div>
											<div class="form-group row">
												<label for="inputSSN" class="col-lg-2 col-form-label">SSN</label>
												<div class="col-lg-10">
													<input type="text" class="form-control" id="inputSSN">
												</div>
											</div>
											<div class="form-group row">
												<label for="inputProductKey" class="col-lg-2 col-form-label">Product Key</label>
												<div class="col-lg-10">
													<input type="text" class="form-control" id="inputProductKey">
												</div>
											</div>
											<div class="form-group row">
												<label for="inputPercent" class="col-lg-2 col-form-label">Percent</label>
												<div class="col-lg-10">
													<input type="text" class="form-control" id="inputPercent">
												</div>
											</div>
											<div class="form-group row">
												<label for="inputCurrency" class="col-lg-2 col-form-label">Currency</label>
												<div class="col-lg-10">
