...
if(empty($_SESSION['user']) && $_SESSION['user_type'] != 'admin'){
	...
	$sql = "SELECT * FROM review_details r1, user_details u1, business_details b1 WHERE r1.user_id = u1.user_id AND r1.business_id = b1.business_id";	
								...
								<div class="panel-body">
									<div class="basic-datatable-block table-responsive">
										<table id="basic_datatable" class="display table table-bordered basic-data-table">
											<thead>
												<tr>
													<th class="view-message">Reviewer Name</th>
													<th class="view-message">Reviewer Email</th>
													<th class="view-message">Seller Name</th>
													<th class="view-message">Ratings</th>
													<th class="view-message">Subject</th>
													<th class="view-message">Review</th>
												</tr>
											</thead>
											<tbody>
