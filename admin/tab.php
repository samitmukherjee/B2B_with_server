...
<!-- Mirrored from themerail.com/html/listingGeo/admin/tab.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 May 2020 13:45:28 GMT -->
<head>
    <meta charset="UTF-8">
	...
	<div class="apps-container-wrap page-container">
		<div class="page-content">
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-6">
						<div class="tab-block box-widget">
							<div class="tab-one tab-common">
								<!-- Nav tabs -->
								<ul class="nav nav-tabs md-pills pills-ins" role="tablist">
									<li class="nav-item">
										<a class="btn btn-raised btn-primary waves-effect waves-light active" data-toggle="tab" href="#panel11" role="tab">Tab No 01</a>
									</li>
									<li class="nav-item">
										<a class="btn btn-raised btn-primary waves-effect waves-light" data-toggle="tab" href="#panel12" role="tab">Tab No 02</a>
									</li>
									<li class="nav-item">
										<a class="btn btn-raised btn-primary waves-effect waves-light" data-toggle="tab" href="#panel13" role="tab">Tab No 03</a>
									</li>
									<li class="nav-item">
										<a class="btn btn-raised btn-primary waves-effect waves-light" data-toggle="tab" href="#panel14" role="tab">Disable Tab</a>
									</li>
								</ul>
								<!-- Tab panels -->
								<div class="tab-content">
									...
									<div class="tab-pane fade in show active" id="panel11" role="tabpanel">
										<h5>Many desktop publishing packages and web</h5>
										<p>
									...
									<div class="tab-pane fade" id="panel13" role="tabpanel">
										<h5>Many mobile app and web app  publishing</h5>
										<p>
											It is a long established fact that a reader will be 
											distracted by the readable content of a page when 
											looking at its layout. The point of using Lorem 
					...
					<div class="col-lg-6">
						<div class="tab-block box-widget">
							<div class="tab-two tab-common">
								<!-- Nav tabs -->
								<ul class="nav nav-tabs md-pills pills-ins" role="tablist">
									<li class="nav-item">
										<a class="btn btn-raised btn-primary waves-effect waves-light active" data-toggle="tab" href="#panel15" role="tab">
											<i class="fa fa-codepen" aria-hidden="true"></i>
										</a>
									</li>
									<li class="nav-item">
										<a class="btn btn-raised btn-primary waves-effect waves-light" data-toggle="tab" href="#panel16" role="tab">
											<i class="fa fa-tachometer" aria-hidden="true"></i>
										</a>
									</li>
									<li class="nav-item">
										<a class="btn btn-raised btn-primary waves-effect waves-light" data-toggle="tab" href="#panel17" role="tab">
					...
					<div class="col-lg-6">
						<div class="tab-block box-widget">
							<div class="tab-three tab-common">
								<!-- Nav tabs -->
								<div class="row">
									<div class="col-md-3">
										<ul class="nav nav-tabs md-pills pills-primary flex-column" role="tablist">
											<li class="nav-item">
												<a class="btn btn-lg btn-primary btn-raised waves-effect active" data-toggle="tab" href="#panel18" role="tab">Tab No 01</a>
											</li>
											<li class="nav-item">
												<a class="btn btn-lg btn-primary btn-raised waves-effect" data-toggle="tab" href="#panel19" role="tab">Tab No 02</a>
											</li>
											<li class="nav-item">
												<a class="btn btn-lg btn-primary btn-raised waves-effect" data-toggle="tab" href="#panel20" role="tab">Tab No 03</a>
											</li>
										</ul>
									</div>
									<div class="col-md-9">
							...
							<div class="tab-four tab-common">
								...
								<div class="row">
									...
									<div class="col-md-3">
										<ul class="nav nav-tabs md-pills pills-primary flex-column" role="tablist">
											<li class="nav-item">
												<a class="btn btn-lg btn-primary btn-raised waves-effect active" data-toggle="tab" href="#panel21" role="tab">Tab No 01</a>
											</li>
											<li class="nav-item">
												<a class="btn btn-lg btn-primary btn-raised waves-effect" data-toggle="tab" href="#panel22" role="tab">Tab No 02</a>
											</li>
											<li class="nav-item">
												<a class="btn btn-lg btn-primary btn-raised waves-effect" data-toggle="tab" href="#panel23" role="tab">Tab No 03</a>
											</li>
										</ul>
									</div>
								</div>
							...
							<div class="tab-four tab-common">
								...
								<div class="row">
									<div class="col-md-1">
										<ul class="nav nav-tabs md-pills pills-primary flex-column" role="tablist">
											<li class="nav-item">
												<a class="btn btn-primary btn-raised waves-effect active vertical-btn" data-toggle="tab" href="#panel24" role="tab"><span>Tab No 01</span></a>
											</li>
											<li class="nav-item">
												<a class="btn btn-primary btn-raised waves-effect vertical-btn" data-toggle="tab" href="#panel25" role="tab"><span>Tab No 02</span></a>
											</li>
										</ul>
									</div>
									<div class="col-md-11">
										...
										<div class="tab-content vertical">
											<!--Panel 1-->
											<div class="tab-pane fade in show active" id="panel24" role="tabpanel">
												<h5>Many desktop publishing packages and web</h5>
												<p>
													It is a long established fact that a reader will be 
													distracted by the readable content of a page when 
							...
							<div class="tab-four tab-common">
								...
								<div class="row">
									<div class="col-md-11">
										...
										<div class="tab-content vertical">
											<!--Panel 1-->
											<div class="tab-pane fade in show active" id="panel26" role="tabpanel">
												<h5>Many desktop publishing packages and web</h5>
												<p>
													It is a long established fact that a reader will be 
													distracted by the readable content of a page when 
									...
									<div class="col-md-1">
										<ul class="nav nav-tabs md-pills pills-primary flex-column" role="tablist">
											<li class="nav-item">
												<a class="btn btn-primary btn-raised waves-effect active vertical-btn" data-toggle="tab" href="#panel26" role="tab"><span>Tab No 01</span></a>
											</li>
											<li class="nav-item">
												<a class="btn btn-primary btn-raised waves-effect vertical-btn" data-toggle="tab" href="#panel27" role="tab"><span>Tab No 02</span></a>
											</li>
										</ul>
									</div>
								</div>
