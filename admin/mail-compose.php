			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown icon-dropdown">
					...
					<ul class="dropdown-menu card-dropdown right">
					  ...
					  <li><div class="drop-footer"><a href="inbox.php">Check all notification</a></div></li>
					</ul>
				</li>
			</ul>
		</div>
			...
			<div class="container-fluid">
				...
				<div class="inbox-wrap">
					<div class="row">
						...
						<div class="inbox-view-wrap col-lg-10">
											...
											<form class="form-common">
												<div class="row">							
													<div class="form-group col-lg-6">
														<input type="email" class="form-control" id="input-to-mail" placeholder="To">
													</div>
													<div class="form-group col-lg-6">
														<input type="email" class="form-control renter-block" placeholder="Cc">
													</div>
												</div>
												...
												<div class="form-group">
													<textarea class="compose-box" rows="8">
														
													</textarea>
												</div>
												<div class="form-btn-block text-right">
													<button type="submit" class="btn btn-raised btn-primary waves-effect waves-light">
