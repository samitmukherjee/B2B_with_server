...
<!-- Mirrored from themerail.com/html/listingGeo/admin/google-map.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 May 2020 13:45:31 GMT -->
<head>
    <meta charset="UTF-8">
...
<body class="menu-collapsed">
						...
						<div class="box-widget">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div id="map-one" class="map-style-one"></div>
								</div><!--panel Body -->
							</div><!--panel -->
						</div><!-- widget-module -->
					</div>
					<div class="col-lg-6">
						<div class="box-widget">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div id="map-two" class="map-style-two"></div>
								</div><!--panel Body -->
							</div><!--panel -->
						</div><!-- widget-module -->
					</div>
					<div class="col-lg-6">
						<div class="box-widget widget-module">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div id="map-three" class="map-style-two"></div>
								</div><!--panel Body -->
							</div><!--panel -->
						</div><!-- widget-module -->
					</div>
	...
	<script>
	  $(document).ready(function() {
		function initMapOne() {
			var map = new google.maps.Map($('#map-one').get(0), {
			  center: {lat: 41.850033, lng: -87.650052},
			  zoom: 10,
			  scrollwheel: false,
			});
		...
		function initMapTwo() {
			var map = new google.maps.Map($('#map-two').get(0), {
			  center: {lat: 37.964, lng: -122.015},
			  zoom: 14,
			  scrollwheel: false,
			  mapTypeId: 'satellite'
			});
		...
		function initMapThree() {
			...
			var map = new google.maps.Map($('#map-three').get(0), {
			  zoom: 15,
			  scrollwheel: false,
			  center: origin
			});
