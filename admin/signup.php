								...
								<form class="form-common">
									<div class="row">
										<div class="form-group col-lg-6">
											<input type="text" class="form-control" id="input-name-one" placeholder="First Name">
										</div>
										<div class="form-group col-lg-6">
											<input type="text" class="form-control renter-block" placeholder="Last Name">
										</div>
									</div>
									...
									<div class="row">
										<div class="form-group password-group col-lg-6">
											<input type="password" class="form-control" id="input-passwoed-one" placeholder="Password">
										</div>
										<div class="form-group password-group col-lg-6">
									...
									<div class="form-btn-block">
										<button type="button" class="btn btn-raised btn-primary waves-effect waves-light btn-block">Sign Up</button>
									</div>
								</form>
