			...
			<div class="container-fluid">
				<div class="row">
					<div class="page-title-block">
						<h4>Manage Executives</h4>
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="#"><i class="ti-home"></i></a></li>
							<!-- <li class="breadcrumb-item"><a href="#">MailBox</a></li> -->
							<li class="breadcrumb-item active">Add Executives</li>
						</ol>
					</div>
				</div>
				...
				<div class="container">
				<form id="add_listing_form" method="POST" class="form-common add-listing-form" action="./php_form/add_executive_form.php" enctype="multipart/form-data" novalidate="novalidate" style="padding: 20px; text-align: center;">
					<!-- Primary Information -->
						...
						<div class="row">
							...
							<div class="col-lg-6">
								<div class="businessinfo-right-block">
									...
									<!-- <input id="business_id" name="business_id" type="hidden" value="<?php echo($_SESSION['admin']); ?>" class="form-control form-single-element" placeholder="Enter first name of the business executive here." aria-required="true" disabled> -->
										<label for="first_name">First Name</label>
										<input id="first_name" name="first_name" type="text" class="form-control form-single-element" placeholder="Ex: Nipun" required>
									</div>
									<div class="form-group">
										<label for="contact_no">Contact Number</label>
										<input id="contact_no" name="contact_no" type="text" class="form-control form-single-element" placeholder="Ex: 0000000000" required>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
                                        ...
                                        <input id="password_1" name="password_1" type="text" class="form-control form-single-element" placeholder="Enter password." aria-required="true" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="password_2">Confirm Password *</label>
                                        <input id="password_2" name="password_2" type="text" class="form-control form-single-element" placeholder="Re-Enter password." aria-required="true" required>
                                    </div>	
								</div>
							</div>
							...
							<div class="col-lg-6">
								<div class="businessinfo-right-block">
									<div class="form-group">
										...
										<input id="last_name" name="last_name" type="text" class="form-control form-single-element" placeholder="Ex: Sharma" required>
									</div>
									<div class="form-group">
                                        <label for="email_id">Email Id *</label>
                                        <input id="email_id" name="email_id" type="text" class="form-control form-single-element" placeholder="Ex: business_executive@gmail.com" aria-required="true" required>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
                                        ...
                                        <input type="file" class="form-control-file" id="profile_picture" name="profile_picture" accept="image/png, image/jpeg, image/jpg" required style="opacity: 1; margin-top: 33px;">
                                    	<br><br><br><span>Maximum file size: 10 MB.</span>
									</div>
								</div>
							</div>
						</div>
