...
<!-- Mirrored from themerail.com/html/listingGeo/admin/chart.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 May 2020 13:45:29 GMT -->
<head>
    <meta charset="UTF-8">
					...
					<div class="col-lg-6">
						<div class="box-widget">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div id="canvas-holder_1" style="width:100%">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<div id="canvas-holder" style="width:100%">
									<canvas id="doghunt_chart"></canvas>
								</div>
							</div><!--panel Body -->
						</div><!--panel -->
						</div><!-- widget-module -->
