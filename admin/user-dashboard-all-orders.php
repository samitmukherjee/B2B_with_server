<?php
	...
	$query_show_orders = "SELECT * FROM enquiry_details, business_details, user_details,product_details, unit_table 
			...
			AND enquiry_details.unit_id = unit_table.unit_id
										...
										<ul>
											...
											<li>
												...
												<div class="review-content">
													<h4><a href="#"><b><?php echo $row_show_orders['product_name'] ?></b> From Seller <?php echo $row_show_orders['legal_name'] ?></a></h4>
													<div class="review-entry">
														<p>
															<?php echo "".$row_show_orders['product_quantity']." ".$row_show_orders['unit_name']."" ?>
														</p>
													</div>
