										...
										<form class="form-common user-profile-form">
											<div class="form-group">
												<div class="edit-profile-photo">
													<img src="images/misc/demo-user.png" alt="img" class="img-responsive">
												</div>
											</div>
											<div class="row">
												<div class="col-lg-6">
													<div class="businessinfo-left-block">
														<div class="form-group">
															...
															<p id="first_name" class="form-control form-single-element">First Name</p>
														</div>
													</div>
												</div>
												<div class="col-lg-6">
													<div class="businessinfo-left-block">
														<div class="form-group">
															...
															<p id="last_name" class="form-control form-single-element">Last Name</p>
														</div>
													</div>
												</div> 
											</div>
											<div class="form-group">
												...
												<p id="email" class="form-control form-single-element">abc@info.com</p>
											</div>
											<div class="form-group">
												<label for="contact_no">Contact Number</label>
												<p id="contact_no" class="form-control form-single-element">+1 0000000000</p>
											</div>
