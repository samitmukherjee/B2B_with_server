    ...
    <div class="main-wrap">
        ...
        <div class="main-nav-section">
            ...
            <nav class="navbar navbar-toggleable-md fixed-top">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarCollapse" style="width: 90%">
                    <ul class="navbar-nav">
                        ...
                        <!-- <li class="nav-item dropdown">
                            <a href="login.php" class="user-login-btn" style="border: 1px solid #e7e7e7; text-align: center; line-height: 31px; color: #fff; padding: 2px 31px !important; margin-top: 3px;">
                                <i class="fa fa-user-o" aria-hidden="true"></i> Log in
                            </a>
                        </li> -->
                        <li class="nav-item dropdown">
                            ...
                            <div class="form-block">
                                <form class="form-common" action="./php_form/user_login.php" method="POST">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="userName" name="user_email" placeholder="Enter your Username" value="<?php if(isset($_COOKIE["user_name"])) { echo $_COOKIE["user_name"]; } ?>" required autocomplete="off">
                                    </div>
                                    <div class="form-group">
                                        <label for="password">Password *</label>
                                        <input type="password" class="form-control" id="password" name="user_password" placeholder="Enter your Password" value="<?php if(isset($_COOKIE["user_password"])) { echo $_COOKIE["user_password"]; } ?>" required autocomplete="off">
                                    </div>
