...
<!-- Mirrored from themerail.com/html/listingGeo/dashboard-profile.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 May 2020 13:44:32 GMT -->
<head>
    <meta charset="UTF-8">
                        ...
                        <li class="nav-item dropdown">
						 ...
						 <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink3">
                                ...
                                <!-- <li><a class="dropdown-item" href="product-listing.php">Add new listings</a></li>
									...
									<div class="panel-body">
										<form class="form-common user-profile-form">
											<div class="form-group">
												...
												<p id="listing_name" class="form-control form-single-element">Business Name</p>
											</div>
											<div class="form-group">
												<label for="listing_name">Business Tagline</label>
												<p id="listing_name" class="form-control form-single-element">Tagline</p>
											</div>
											<div class="form-group">
												<label for="listing_name">Contact Number</label>
												<p id="listing_name" class="form-control form-single-element">+1 0000000000</p>
											</div>
											<div class="form-group">
												<label for="listing_name">Email Address</label>
												<p id="listing_name" class="form-control form-single-element">abc@info.com</p>
											</div>
											<div class="form-group">
												<label for="listing_name">Address</label>
												<p id="listing_name" class="form-control form-single-element">Full Address</p>
											</div>
											<table>
												<tr>
													<td width= 275>
														<div class="form-group">
															...
															<p id="listing_name" class="form-control form-single-element">Country Name</p>
														</div>
													</td>
													<td width= 275>
														<div class="form-group">
															<label for="listing_name">State</label>
															<p id="listing_name" class="form-control form-single-element">State Name</p>
														</div>
													</td>
												</tr>
											...
											<div class="form-group">
												...
												<p id="listing_name" class="form-control form-single-element">000000</p>
											</div>
											<!-- <div class="form-group">
												<p class="form-control">Bussiness Tagline</p>
											</div>
											<div class="form-group">
												<p class="form-control">Bussiness Address</p>
											</div>
											<div class="form-group textarea-form-group">
												<p class="form-control">Contact Number</p>
											</div>
											<div class="form-group">
												<p class="form-control">Email Address </p>
											</div>
											<div class="form-group">
												<p class="form-control">Contact Number</p>
											</div>
											...
											<button type="submit" class="listing-btn-large">Save Change</button>  -->
										</form>
									</div><!--panel Body -->
								</div><!--panel -->
							</div>
