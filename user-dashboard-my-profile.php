...
<body class="dashboard">
    <div class="main-wrap" style="width: 100%;">
        ...
        <div class="add-listing-wrap" style="margin-bottom: 20px; margin-left:100px; margin-top: 100px;">
			<div class="container">
				<form id="update_profile_form" method="POST" class="form-common add-listing-form" action="./php_form/update_profile_form.php" enctype="multipart/form-data" novalidate="novalidate" style="padding: 20px; text-align:center;">
						...
						<div class="row">
							<div class="col-lg-2">
								<div class="form-group" style="max-width: 100%; max-height: 100%; display: block;">
									<div>
										<img src="<?php echo $row_user_details['user_profile_picture']?>" style="width: 125px; height:125px;">
									</div>
								</div>
							</div>
							<div class="col-lg-10">
								<div class="form-group" style="width: 100%; height: 100%;">
									<div>
										...
										<input type="file" class="form-control-file" id="profile_picture" name="profile_picture" required style="opacity: 1; padding-top: 10px;">
							...
							<div class="col-lg-6">
								<div class="businessinfo-left-block">
									<div class="form-group">
										<input name="user_id" value="<?php echo $_SESSION['user']?>" type="hidden">
										<label>First Name</label>
										<input id="first_name" name="first_name" type="text" class="form-control form-single-element" value="<?=$row_user_details['first_name'] ?>" placeholder="Ex: Manas" required>
									</div>
									<div class="form-group">
										<label>Contact Number</label>
										<input id="contact_no"  name="contact_no" type="text" class="form-control" value="<?=$row_user_details['phone_no'] ?>" placeholder="Ex: +91-000-000-0000" required>
									</div>
								</div>
							</div>
							<!-- col-lg-6 -->
							<div class="col-lg-6">
								...
								<div class="form-group">
										...
										<input id="last_name"  name="last_name" type="text" class="form-control form-single-element" value="<?=$row_user_details['last_name'] ?>" placeholder="Ex: Singh" required>
									</div>
									<div class="form-group">
										<label>Email ID</label>
										<input id="email_id" name="email_id" type="email" class="form-control" value="<?=$row_user_details['user_email_id'] ?>" placeholder="Ex: info@example.com" required>
									</div>
								</div>
							</div>
						</div>
