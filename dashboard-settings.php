...
<!-- Mirrored from themerail.com/html/listingGeo/dashboard-settings.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 May 2020 13:44:32 GMT -->
<head>
    <meta charset="UTF-8">
							...
							<div class="box-widget">
								<div class="panel panel-default">
									...
									<div class="panel-body">
												...
												<tr>
													<td>
														<div class="form-group additionalinfo-toggle-switch">
															...
															<label for="aditionalInfo1">Profile Status</label>
														</div>
													</td>
												</tr>
												<tr>
													<td>
														<div class="form-group additionalinfo-toggle-switch">
															...
															<label for="aditionalInfo2">Listing Review</label>
														</div>
													</td>
												</tr>
												<tr>
													<td>
														<div class="form-group additionalinfo-toggle-switch">
															...
															<label for="aditionalInfo3">Send SMS</label>
														</div>
													</td>
												</tr>
												<tr>
													<td>
														<div class="form-group additionalinfo-toggle-switch">
															<input type="checkbox" id="aditionalInfo4">
															<label for="aditionalInfo4">Get Quotes</label>
														</div>
													</td>
												</tr>
												<tr>
													<td>
														<div class="form-group additionalinfo-toggle-switch">
															...
															<label for="aditionalInfo5">Show Contact Info</label>
														</div>
													</td>
												</tr>
												<tr>
													<td>
														<div class="form-group additionalinfo-toggle-switch">
															<input type="checkbox" id="aditionalInfo6">
															<label for="aditionalInfo6">Listing Guarantee</label>
														</div>
													</td>
												</tr>
												<tr>
													<td>
														<div class="form-group additionalinfo-toggle-switch">
															<input type="checkbox" checked id="aditionalInfo7">
															<label for="aditionalInfo7">Show Profile Info</label>
														</div>
													</td>
												</tr>
												<tr>
													<td>
														<div class="form-group additionalinfo-toggle-switch">
															<input type="checkbox" id="aditionalInfo8">
															<label for="aditionalInfo8">Show Contact Info</label>
														</div>
													</td>
												</tr>
												<tr>
													<td>
														<div class="form-group additionalinfo-toggle-switch">
															<input type="checkbox" id="aditionalInfo9">
															<label for="aditionalInfo9">Social Media Share</label>
														</div>
													</td>
												</tr>
												<tr>
													<td>
														<div class="form-group additionalinfo-toggle-switch">
															<input type="checkbox" checked id="aditionalInfo10">
															<label for="aditionalInfo10">Show Website Ads</label>
														</div>
													</td>
												</tr>
											</tbody>
										...
										<p>
											listingGEO is a limited digital marketing company specializing listingGEO listingGEO
											is a limited digit al marketing
										</p>
										<a href="#" class="listing-btn-cmn">Save Settings</a>
									</div><!--panel Body -->
								</div><!--panel -->
							</div>
						</div>
						<div class="col-lg-6">
							<div class="box-widget">
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<form class="form-common user-profile-form">
