...
<!-- Mirrored from themerail.com/html/listingGeo/listing-map-left.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 May 2020 13:44:09 GMT -->
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="main-wrap">
        ...
        <div class="main-nav-section main-nav-two-section">
            ...
            <nav class="navbar navbar-toggleable-md fixed-top">
                ...
                <a class="navbar-brand" href="home-one.php">
                    <img src="images/logo-two.png" alt="img" class="img-responsive">
                </a>
        ...
        <div class="listing-map-block-fullwrap">
            <div class="listing-map-section listing-map-half listing-map-left">
                <div class="listing-map-holder">
                    <div class="listing-map-container">
                        <div class="listing-map-block" id="map-canvas"></div>
                    </div>
                </div>
                <div class="listing-filter-wrap">
							...
							<div class="container">
								...
								<div id="products" class="row product-list-group">
									...
									<div class="item col-lg-4 col-md-6">
										<article class="popular-listing-post">
											<div class="post-thumb">
												<img src="images/post/12.jpg" alt="img" class="img-responsive">
												<div class="listing-info">
													<h4><a href="javascript:void(0)">Hotel California</a></h4>
													<p><i class="fa fa-bed" aria-hidden="true"></i> Hotel & Restaurent</p>
												</div>
												...
												<div class="option-block">
													<ul>
														...
														<li>
															<a href="javascript:void(0)" data-lat="40.715877,-73.993959" data-toggle="modal" data-target="#post_listing_modal_four">
																<i class="fa fa-eye" aria-hidden="true"></i>
															</a>
														</li>
													</ul>
									...
									<div class="item col-lg-4 col-md-6">
										<article class="popular-listing-post">
											<div class="post-thumb">
												<img src="images/post/13.jpg" alt="img" class="img-responsive">
												<div class="listing-info">
													<h4><a href="javascript:void(0)">Hotel California</a></h4>
													<p><i class="fa fa-bed" aria-hidden="true"></i> Hotel & Restaurent</p>
												</div>
												...
												<div class="option-block">
													<ul>
														...
														<li>
															<a href="javascript:void(0)" data-lat="40.715877,-73.993959" data-toggle="modal" data-target="#post_listing_modal_five">
																<i class="fa fa-eye" aria-hidden="true"></i>
															</a>
														</li>
													</ul>
											...
											<div class="post-thumb">
												...
												<div class="option-block">
													<ul>
														...
														<li>
															<a href="javascript:void(0)" data-lat="40.715877,-73.993959" data-toggle="modal" data-target="#post_listing_modal_six">
																<i class="fa fa-eye" aria-hidden="true"></i>
															</a>
														</li>
													</ul>
					...
					<div class="listing-modal-content-section">
						<div class="container">
							...
							<div class="modal fade listing-modal" id="post_listing_modal_four" tabindex="-1" role="dialog" aria-hidden="true">
								<div class="modal-dialog post-model">
									<button type="button" class="close" data-dismiss="modal" aria-label="Close">
										<span aria-hidden="true">&times;</span>
									</button>
									<div class="modal-content">
										<div class="row">
											...
											<div class="col-lg-6">
												<div class="row">
													<div id="listing_post_map_four" class="listing-post-map"></div>
												</div>
											</div>
										</div>
									</div>
							...
							<div class="modal fade listing-modal" id="post_listing_modal_five" tabindex="-1" role="dialog" aria-hidden="true">
								<div class="modal-dialog post-model">
									<button type="button" class="close" data-dismiss="modal" aria-label="Close">
										<span aria-hidden="true">&times;</span>
									</button>
									<div class="modal-content">
										<div class="row">
											...
											<div class="col-lg-6">
												<div class="row">
													<div id="listing_post_map_five" class="listing-post-map"></div>
												</div>
											</div>
										</div>
									</div>
							...
							<div class="modal fade listing-modal" id="post_listing_modal_six" tabindex="-1" role="dialog" aria-hidden="true">
								<div class="modal-dialog post-model">
									<button type="button" class="close" data-dismiss="modal" aria-label="Close">
										<span aria-hidden="true">&times;</span>
									</button>
									<div class="modal-content">
										<div class="row">
											...
											<div class="col-lg-6">
												<div class="row">
													<div id="listing_post_map_six" class="listing-post-map"></div>
												</div>
											</div>
										</div>
									</div>
                    ...
                    <p class="listing-copy-right">
                        Copyright 2018, <a href="#">ListingGEO</a>. All Rights Reserved
                    </p>
                </div>
                <!-- listing-filter-wrap -->
            </div>
...
<!-- Mirrored from themerail.com/html/listingGeo/listing-map-left.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 May 2020 13:44:12 GMT -->
</html>