...
<!-- Mirrored from themerail.com/html/listingGeo/packages.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 May 2020 13:44:23 GMT -->
<head>
    <meta charset="UTF-8">
        ...
        <div class="breadcrumb-block">
            <div class="container">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Listing Packages</li>
                </ol>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="pricing-block">
                            <p class="pricing-heading">General</p>
                            ...
                            <div class="packages">
                                ...
                                <p>24/7 Playing</p>
                                <p>Live Podcast</p>
                                <p>Multilanguage System</p>
                                <p>Purchase Option</p>
                            </div>
                            <a href="javascript:void(0)" class="pricing-btn">Purchase Now</a>
                        </div>
                    </div>
                    <!-- priceing table -->
                    <div class="col-lg-4 col-md-6">
                        <div class="pricing-block standard">
                            <p class="pricing-heading">Standard</p>
                            <div class="price-block">
                                <h4>$25 / Month</h4>
                            </div>
                            <div class="packages">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="pricing-block">
                            <p class="pricing-heading">Professional</p>
                            <div class="price-block">
                                <h4>$25 / Month</h4>
                            </div>
                            <div class="packages">
