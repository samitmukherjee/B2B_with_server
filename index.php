...
<!-- Mirrored from themerail.com/html/listingGeo/home-one.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 May 2020 13:43:30 GMT -->
<head>
    <meta charset="UTF-8">
            ...
            <div class="container">
                <div class="header-content-block">
                    <div class="header-title-block">
                        ...
                        <p>Find Products and Services as per your requirements!</p>
                    </div>
                    <form class="form-common filter-form filter-header-form">
                        ...
                        <div class="form-group outer-select-field">
                            <a class="input-dropedown-btn" href="javascript:void(0)">
                                <i class="fa fa-crosshairs" aria-hidden="true"></i> Keyword
                            </a>
                            <input type="text" class="outer-select-input-box" id="listing_keword" placeholder="Ex: Dress, Pendrive">
                        </div>
                        <div class="btn-group">
...
<!-- Mirrored from themerail.com/html/listingGeo/home-one.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 May 2020 13:43:51 GMT -->
</html>