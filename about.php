...
<!-- Mirrored from themerail.com/html/listingGeo/about.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 May 2020 13:44:21 GMT -->
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="main-wrap">
        ...
        <div class="about-info-section">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 push-lg-6 col-md-12">
                        <div class="about-thumb">
                            <img src="images/misc/4.jpg" alt="img" class="img-responsive">
                        </div>
                    </div>
                    <div class="col-lg-6 pull-lg-6 col-md-12">
                        <div class="about-info">
                            <h2>We are B2B Marketplace</h2>
                            <p>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="team-member-block">
                            <div class="team-member-thumb-outer">
                                <div class="team-member-thumb">
                                    <img src="images/team/1.jpg" alt="img" class="img-responsive">
                                    <ul>
                                        <li>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="team-member-block">
                            <div class="team-member-thumb-outer">
                                <div class="team-member-thumb">
                                    <img src="images/team/2.jpg" alt="img" class="img-responsive">
                                    <ul>
                                        <li>
                                            <a href="javascript:void(0)">
                                                <i class="fa fa-facebook" aria-hidden="true"></i>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="team-member-block">
                            <div class="team-member-thumb-outer">
                                <div class="team-member-thumb">
                                    <img src="images/team/3.jpg" alt="img" class="img-responsive">
                                    <ul>
                                        <li>
                                            <a href="javascript:void(0)">
                                                <i class="fa fa-facebook" aria-hidden="true"></i>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="team-member-block">
                            <div class="team-member-thumb-outer">
                                <div class="team-member-thumb">
                                    <img src="images/team/4.jpg" alt="img" class="img-responsive">
                                    <ul>
                                        <li>
                                            <a href="javascript:void(0)">
                                                <i class="fa fa-facebook" aria-hidden="true"></i>
        ...
        <!-- team section -->
        <div class="popular-listing-two-section">
            <div class="overlay"></div>
            <div class="container">
                <div class="section-title">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <article class="popular-listing-post popular-post-two">
                            <div class="post-thumb">
                                <img src="images/post/15.jpg" alt="img" class="img-responsive">
...
<!-- Mirrored from themerail.com/html/listingGeo/about.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 May 2020 13:44:23 GMT -->
</html>