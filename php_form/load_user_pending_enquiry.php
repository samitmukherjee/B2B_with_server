...
$sql = "SELECT enquiry_id, e1.enquiry_message, e1.enquiry_attachment, e1.enquiry_status, e1.product_unit, e1.product_quantity, e1.product_id, product_name, product_image_1, b1.legal_name 
        FROM enquiry_details e1, product_details p1, business_details b1 WHERE e1.product_id = p1.product_id AND e1.enquiry_status = '0' AND e1.user_id = '$user_id' LIMIT $enquiry_new_count";
// echo $sql;
// echo $business_id;
