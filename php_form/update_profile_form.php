    ...
    if(isset($_POST['submit_button'])){
        ...
        if($_FILES['profile_picture']['size'] != 0){
            ...
            if(in_array($file_actual_extension, $allowed)){
                if($file_error === 0){
                    if($file_size < 1000000){
                        ...
                        $file_dest = '../uploads/user_details/user_profile_picture/'.$file_name_new;
                        $file_dest_1 = './uploads/user_details/user_profile_picture/'.$file_name_new;
            ...
            if(isset($profile_picture_name) and !empty($profile_picture_name)){
                $location = '../uploads/user_details/user_profile_picture/';
                $location_1 = './uploads/user_details/user_profile_picture/';
        ...
        if($_FILES['profile_picture']['size'] != 0){
            echo "TEST";
            $query_update_profile = " UPDATE user_details SET first_name='".$first_name."', last_name='".$last_name."', phone_no='".$contact_no."',
                                        user_email_id='".$email_id."', user_profile_picture='".$file_dest_1."' WHERE user_email_id = '".$user_id."' ";
            echo $query_update_profile;
        }else{
            // echo "TEST2";
            $query_update_profile = " UPDATE user_details SET first_name='".$first_name."', last_name='".$last_name."', phone_no='".$contact_no."',
                                         user_email_id='".$email_id."' WHERE user_email_id = '".$user_id."' ";
        } 
