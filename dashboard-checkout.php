...
<!-- Mirrored from themerail.com/html/listingGeo/dashboard-checkout.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 May 2020 13:44:31 GMT -->
<head>
    <meta charset="UTF-8">
					...
					<div class="col-lg-9 offset-lg-1">
						<div class="checkout-block">
							<div class="product-block">
								<img src="images/misc/cart-image.jpg" alt="img" class="img-responsive">
							</div>
							<div class="cart-info">
								<h2>
									Ship Your Proudct
								...
								<p>
									ome people say timing is everything, but I'd argue language is everything
									— especially when it comes to wine. We've all been there — standing 
									in the wine aisle, paralyzed by the wealth of choices.
								</p>
								<a href="#" class="listing-btn-cmn">
									Add to cart
								</a>
							</div>
						</div>
